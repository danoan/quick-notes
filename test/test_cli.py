...
def test_generate_markdown(num_entries, tmp_path):
    ...
    quick_note_table = generate_mock_quick_note_table(num_entries)
...
def test_generate_toml(num_entries, tmp_path):
    ...
    markdown_string = generate_mock_quick_note_markdown(num_entries)
    ...
    # Ground Truth
    markdown_from_generated_quick_note_table = to_markdown.parse(quick_note_table)

    # Comparison
    assert to_toml.parse(markdown_string) == to_toml.parse(markdown_from_generated_quick_note_table)
